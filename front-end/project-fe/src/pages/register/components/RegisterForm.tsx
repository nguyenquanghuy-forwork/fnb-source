...
const RegisterForm = (props: RegisterFormProps) => {
  ...
  return (
    <Form form={form} onFinish={handleRegister} className="register-form">
      ...
      <Row style={{ flexDirection: 'column', gap: 12 }}>
        <RegisterLabel label={t('Store Name')} required={true} />
        <Form.Item
          name="storeName"
          rules={[
            {
              required: true,
              message: t('Please input Store Name'),
            },
          ]}
        >
          <Input style={inputStyle} maxLength={255} placeholder={t('Input your Store Name')} />
        </Form.Item>
      </Row>
      <Row style={{ flexDirection: 'column', gap: 12 }}>
